...
config :customize_ash_authentication, CustomizeAshAuthenticationWeb.Endpoint,
  ...
  render_errors: [
    formats: [
      html: CustomizeAshAuthenticationWeb.ErrorHTML,
      json: CustomizeAshAuthenticationWeb.ErrorJSON
    ],
    layout: false
  ],
  pubsub_server: CustomizeAshAuthentication.PubSub,
  live_view: [signing_salt: "xD6dlh0h"]
